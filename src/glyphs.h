#ifndef GLYPH_snake_logo_BPP
        #define GLYPH_snake_logo_WIDTH 16
        #define GLYPH_snake_logo_HEIGHT 16
        #define GLYPH_snake_logo_BPP 1
extern unsigned int const C_snake_logo_colors[];
extern unsigned char const C_snake_logo_bitmap[32];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_snake_logo;
        #endif // GLYPH_snake_logo_BPP
        #endif // HAVE_BAGL
