#include "glyphs.h"
unsigned int const C_snake_logo_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_snake_logo_bitmap[] = {
  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x1f, 0xfa, 0xdf, 0xff, 0xdf, 0xff, 0x1f, 0xe0,
  0xff, 0xef, 0xff, 0xef, 0xff, 0xef, 0x07, 0xe0, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_snake_logo = { GLYPH_snake_logo_WIDTH, GLYPH_snake_logo_HEIGHT, 1, C_snake_logo_colors, C_snake_logo_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
